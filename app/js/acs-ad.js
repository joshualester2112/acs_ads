// (function(){
	window.onload = function () {
		var veil = document.getElementById('veil'),
			acsBackground = document.getElementById('acs-ad-background'),
		...
		tl1.to(veil, 0.6, {opacity: 0, ease: Power0.noEase})
			.to(acsBackground, 6, { scale: 0.8, y: -25, ease: Power1.easeInOut}, '-=0.3')
			.to(acsBackground, 6, { scale: 0.5, y: 0, ease: Power1.easeInOut}, '-=0')
		;
		...
		tl2.from(txt1, 0.5, { top: 129, opacity: 0, ease: Power1.easeIn }, '+=0.3')
			...
			.to(txt1, 0.5, { opacity: 0, ease: Power1.easeIn }, '+=2.2')
